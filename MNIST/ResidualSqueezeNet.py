...
# Residual 1
fire2_expand3 = residual_block(fire2_squeeze, 64, 5, 5)
#fire2_expand4 = residual_block(fire2_squeeze, 64, 3, 3)
merge1 = merge(inputs=[fire2_expand1, fire2_expand2, fire2_expand3, ], mode="concat", concat_axis=1)
...
# Residual 2
fire3_expand3 = residual_block(fire3_squeeze, 64, 5, 5)
#fire3_expand4 = residual_block(fire3_squeeze, 64, 3, 3)
merge2 = merge(inputs=[fire3_expand1, fire3_expand2, fire3_expand3, ], mode="concat", concat_axis=1)
...
#Residual 3
fire4_expand3 = residual_block(fire4_squeeze, 128, 5, 5)
#fire4_expand4 = residual_block(fire4_squeeze, 128, 3, 3)
merge3 = merge(inputs=[fire4_expand1, fire4_expand2, fire4_expand3, ], mode="concat", concat_axis=1)
...
# Residual 5
fire5_expand3 = residual_block(fire5_squeeze, 128, 5, 5)
#fire5_expand4 = residual_block(fire5_squeeze, 128, 3, 3)
merge5 = merge(inputs=[fire5_expand1, fire5_expand2, fire5_expand3, ], mode="concat", concat_axis=1)
...
# Residual 6
fire6_expand3 = residual_block(fire6_squeeze, 192, 5, 5)
#fire6_expand4 = residual_block(fire6_squeeze, 192, 3, 3)
merge6 = merge(inputs=[fire6_expand1, fire6_expand2, fire6_expand3, ], mode="concat", concat_axis=1)
...
# Residual 7
fire7_expand3 = residual_block(fire7_squeeze, 192, 5, 5)
#fire7_expand4 = residual_block(fire7_squeeze, 192, 3, 3)
merge7 = merge(inputs=[fire7_expand1, fire7_expand2, fire7_expand3, ], mode="concat", concat_axis=1)
...
# Residual 8
fire8_expand3 = residual_block(fire8_squeeze, 256, 5, 5)
#fire8_expand4 = residual_block(fire8_squeeze, 256, 3, 3)
merge8 = merge(inputs=[fire8_expand1, fire8_expand2, fire8_expand3, ], mode="concat", concat_axis=1)
...
# Residual 9
fire9_expand3  = residual_block(fire9_squeeze, 256, 5, 5)
#fire9_expand4 = residual_block(fire9_squeeze, 256, 3, 3)
merge8 = merge(inputs=[fire9_expand1, fire9_expand2, fire9_expand3, ], mode="concat", concat_axis=1)
